...
1. Run `gatsby clean` in your project root, this is going to help prevent any issues down the line for us.
...
1. Branding (logo and site title) is now handled using component shadowing. This simplifies the API and gives you more direct control over this crucial presentational element. Take a look at gatsby-starter-catalyst to see how this is done. Also note the shadowing of the branding component as well from the header theme.

1. Update theme options.
