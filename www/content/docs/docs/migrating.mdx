...
- Removal of support for `remark-katex`, implementation of this has been a major headache and there are still currently problems with how remark-katex interacts with MDX. If this affected you please submit an issue and we could discuss adding it back in. I would prefer that you just implement it for your own site.
