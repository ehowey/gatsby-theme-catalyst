...
The following "base theme" is used through Gatsby Theme Catalyst. It provides a consistent starting point for your themes and is based on Tailwind defaults.
