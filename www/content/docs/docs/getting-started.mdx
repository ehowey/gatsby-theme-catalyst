...
Gatsby Theme Catalyst is developer focused at this time and I assume you have a basic understanding of Gatsby and modern web development. If you are brand new I recommend reading the [getting started docs](https://www.gatsbyjs.org/docs/) for Gatsby and coming back here later!

## Install the themes using a starter

This guide uses a barebones starter which is designed to be a boilerplate for further development and customization. It includes a minimal set of styles, utility components and core functionality like a mobile navigation menu. Content is authored in MDX.
