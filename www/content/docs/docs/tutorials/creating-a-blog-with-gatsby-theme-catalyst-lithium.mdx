...
> A more advanced way to change the logo is through [component shadowing](https://www.gatsbyjs.com/docs/themes/shadowing/) which gives you greater control over the logo and file naming. The file you need to shadow is `gatsby-theme-catalyst-header-top/components/branding/branding-logo.js`.
