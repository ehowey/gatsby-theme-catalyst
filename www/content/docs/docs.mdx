...
If you are brand new the best place to start is the [Getting Started](/docs/getting-started) guide. These docs are written with the assumption you are already familiar with Gatsby and modern web design principles.
